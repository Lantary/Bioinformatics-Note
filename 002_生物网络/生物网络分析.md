...
在无向网络中，节点 `v` 的聚类系数 CC<sub>v</sub> 的表达公式为

<img src="http://chart.googleapis.com/chart?cht=tx&chl=CC_{v} = \frac{n}{C_{k}^{2}} = \frac{2n}{k(k-1)}" style="border:none;">
...
节点 A 的聚类系数 $ CC<sub>A</sub> = \frac {1} {2×(2-1)} $
